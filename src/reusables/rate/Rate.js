...
function Rate({area}) {
    return (
        <div className='rate round'>
            ...
            <p className='rate-text med text-dark'>Rated 5 stars in {area}</p>
        </div>
    )
}
